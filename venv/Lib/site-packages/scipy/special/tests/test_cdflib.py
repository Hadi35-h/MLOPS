...
class TestNoncentralTFunctions:
    ...
    @pytest.mark.parametrize(
        ...
        # see https://github.com/boostorg/math/issues/1308
        [
            [3.0, 5.0, -2.0, 1.5645373999149622e-09, 2e-8],
...
class TestPdtrik:
    @pytest.mark.parametrize("p, m, expected", [(0, 0.5, 0), (0.5, 0, 0)])
