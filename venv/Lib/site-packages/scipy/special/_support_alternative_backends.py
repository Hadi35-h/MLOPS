        ...
        if is_marray(xp):
            ...
            def f(*args, _f=_f, xp=xp, **kwargs):
                ...
                mask = functools.reduce(
                    operator.or_, (getattr(arg, "mask", False) for arg in args)
                )
...
_special_funcs = (
    ...
    _FuncInfo(
        _ufuncs.betaincc, 3, _needs_betainc, generic_impl=_betaincc, torch_native=False
    ),
    _FuncInfo(
        _ufuncs.betaincinv,
        3,
    ...
    _FuncInfo(
        ...
        int_only=(True, False),
        is_ufunc=False,
        scalar_or_0d_only={"torch": (True, False)},
        produces_0d=True,
    ...
    _FuncInfo(
        _ufuncs.stdtr, 2, _needs_betainc, generic_impl=_stdtr, torch_native=False
    ),
    _FuncInfo(
        _ufuncs.stdtrit,
        2,
