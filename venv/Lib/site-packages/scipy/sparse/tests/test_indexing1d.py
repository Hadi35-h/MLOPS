...
class TestSlicingAndFancy1D:
    ...
    def test_fancy_indexing_2darray(self, spcreator):
        ...
        assert_equal(toarray(A[[-1, -3], [2, -4]]), B[[-1, -3], [2, -4]])
        assert_equal(toarray(A[np.array([-1, -3]), [2, -4]]), B[[-1, -3], [2, -4]])
        assert_equal(toarray(A[[-1, -3], np.array([2, -4])]), B[[-1, -3], [2, -4]])
        assert_equal(
    ...
    def test_fancy_indexing(self, spcreator):
        ...
        # [[1, 2]][[1, 2]]
        assert_equal(A[[1, 5, 2, 8]][[1, 3]].toarray(), B[[1, 5, 2, 8]][[1, 3]])
        assert_equal(A[[-1, -5, 2, 8]][[1, -4]].toarray(), B[[-1, -5, 2, 8]][[1, -4]])
