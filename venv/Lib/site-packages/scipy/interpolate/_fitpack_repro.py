...
from ._bsplines import (
    ...
    fpcheck,
    _lsq_solve_qr,
    _lsq_solve_qr_for_root_rati_periodic,
    _periodic_knots,
)
...
def _validate_inputs(x, y, w, k, s, xb, xe, parametric, periodic=False):
    ...
    if periodic and not np.allclose(y[0], y[-1], atol=1e-15):
        raise ValueError(
            "First and last points does not match which is required "
...
def generate_knots(
    x, y, *, w=None, xb=None, xe=None, k=3, s=0, nest=None, bc_type=None
):
    ...
    x, y, w, k, s, xb, xe = _validate_inputs(
        x, y, w, k, s, xb, xe, parametric=np.ndim(y) == 2, periodic=periodic
    )
...
class Fperiodic:
    ...
    def __init__(
        self, x, y, t, k, s, w=None, *, R=None, Y=None, A1=None, A2=None, Z=None
    ):
        ...
        if (A1 is None or A2 is None or Z is None) or (R is None and Y is None):
...
@xp_capabilities(cpu_only=True, jax_jit=False, allow_dask_compute=True)
def make_splrep(
    x, y, *, w=None, xb=None, xe=None, k=3, s=0, t=None, nest=None, bc_type=None
):
    ...
    x, y, w, k, s, xb, xe = _validate_inputs(
        x, y, w, k, s, xb, xe, parametric=False, periodic=periodic
    )
...
@xp_capabilities(cpu_only=True, jax_jit=False, allow_dask_compute=True)
def make_splprep(
    x, *, w=None, u=None, ub=None, ue=None, k=3, s=0, t=None, nest=None, bc_type=None
):
    r"""
    ...
    u, x, w, k, s, ub, ue = _validate_inputs(
        u, x, w, k, s, ub, ue, parametric=True, periodic=periodic
    )

    if t is not None:
        t = xp.asarray(t)

    spl = _make_splrep_impl(u, x, w, ub, ue, k, s, t, nest, periodic=periodic, xp=xp)
