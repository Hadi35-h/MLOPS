...
class TestDifferentialEvolutionSolver:
    ...
    def test_polish_function(self):
        ...
        with assert_raises(
            ValueError, match="The result from a user defined polishing"
        ):
            differential_evolution(rosen, self.bounds, polish=dummy_pf, maxiter=1)
        ...
        rng = np.random.default_rng(110980928209)
        res2 = differential_evolution(rosen, self.bounds, polish=pf, rng=rng, maxiter=1)
