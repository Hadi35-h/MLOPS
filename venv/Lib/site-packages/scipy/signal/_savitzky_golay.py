...
def _fit_edge(
    ...
    poly_coeffs = _pu.polyfit(
        xp.arange(0, window_stop - window_start, dtype=x.dtype, device=xp_device(x)),
        xx_edge,
        polyorder,
        xp=xp,
    )
    ...
    i = xp.arange(
        ...
        interp_stop - window_start,
        dtype=poly_coeffs.dtype,
        device=xp_device(poly_coeffs),
    )
...
def _fit_edges_polyfit(x, window_length, polyorder, deriv, delta, axis, y):
    ...
    y = _fit_edge(x, 0, window_length, 0, halflen, axis, polyorder, deriv, delta, y)
    n = x.shape[axis]
    y = _fit_edge(
