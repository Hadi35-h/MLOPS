...
class TestC2D:
    ...
    def test_euler(self, xp):
        ...
        cd_truth = xp.asarray([[0.75, 1.0], [1.0, 1.0], [1.0, 0.25]])
        dd_truth = dc
    ...
    def test_backward_diff(self, xp):
        ...
        cd_truth = xp.asarray([[1.5, 2.0], [2.0, 2.0], [2.0, 0.5]])
        dd_truth = xp.asarray([[0.875], [1.0], [0.295]])
    ...
    def test_bilinear(self, xp):
        ...
        dd_truth = xp.asarray([[0.291666666666667], [1.0 / 3.0], [-0.121666666666667]])
    ...
    def test_zerospolesgain(self, xp):
        ...
        poles_c = xp.array([1.0j / xp.sqrt(2), -1.0j / xp.sqrt(2)])
        k_c = 1.0
