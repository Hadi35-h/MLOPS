...
bilinear_extra_note = """CuPy does not accept complex inputs.

    """

uses_choose_conv_extra_note = """CuPy does not support inputs with ``ndim>1`` when ``method="auto"``
    but does support higher dimensional arrays for ``method="direct"``
    and ``method="fft"``.

    """

resample_poly_extra_note = """CuPy only supports ``padtype="constant"``.

    """

upfirdn_extra_note = """CuPy only supports ``mode="constant"`` and ``cval=0.0``.

    """

xord_extra_note = """The ``torch`` backend on GPU does not support the case where
    `wp` and `ws` specify a Bandstop filter.

    """

convolve2d_extra_note = """The JAX backend only supports ``boundary="fill"`` and ``fillvalue=0``.

    """

zpk2tf_extra_note = """The CuPy and JAX backends both support only 1d input.

    """

capabilities_overrides = {
    "bessel": xp_capabilities(cpu_only=True, jax_jit=False, allow_dask_compute=True),
    "bilinear": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy"],
        jax_jit=False,
    ...
    "bilinear_zpk": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ),
    "butter": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "buttord": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ...
    "cspline1d": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "cspline1d_eval": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "cspline2d": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "czt": xp_capabilities(np_only=True, exceptions=["cupy"]),
    "deconvolve": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy"],
        allow_dask_compute=True,
    ...
    "detrend": xp_capabilities(
        cpu_only=True, exceptions=["cupy", "jax.numpy"], allow_dask_compute=True
    ),
    "dimpulse": xp_capabilities(np_only=True, exceptions=["cupy"]),
    "dlti": xp_capabilities(
        np_only=True, reason="works in CuPy but delegation isn't set up yet"
    ),
    "ellip": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy"],
        jax_jit=False,
        allow_dask_compute=True,
    ...
    "firls": xp_capabilities(
        cpu_only=True, allow_dask_compute=True, jax_jit=False, reason="lstsq"
    ),
    "firwin": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ),
    "firwin2": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy"],
        jax_jit=False,
        allow_dask_compute=True,
    ...
    "freqs": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ),
    "freqs_zpk": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ),
    "freqz": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ),
    "freqz_sos": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ),
    "group_delay": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    ...
    "lfilter": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], allow_dask_compute=True, jax_jit=False
    ),
    "lfilter_zi": xp_capabilities(
        cpu_only=True, allow_dask_compute=True, jax_jit=False
    ),
    "lfiltic": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], allow_dask_compute=True
    ),
    "lp2bp": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        skip_backends=[("jax.numpy", "in-place item assignment")],
    ),
    "lp2bp_zpk": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        jax_jit=False,
    ),
    "lp2bs": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        skip_backends=[("jax.numpy", "in-place item assignment")],
    ),
    "lp2bs_zpk": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        jax_jit=False,
    ),
    "lp2lp": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        jax_jit=False,
    ),
    "lp2lp_zpk": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        jax_jit=False,
    ),
    "lp2hp": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        skip_backends=[("jax.numpy", "in-place item assignment")],
    ),
    "lp2hp_zpk": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        jax_jit=False,
    ...
    "minimum_phase": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        jax_jit=False,
    ),
    "normalize": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ...
    "qspline1d": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "qspline1d_eval": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    ...
    "resample_poly": xp_capabilities(
        ...
        exceptions=["cupy"],
        jax_jit=False,
        skip_backends=[("dask.array", "XXX something in dask")],
    ...
    "sos2zpk": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "sos2tf": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "sosfilt": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], allow_dask_compute=True
    ),
    ...
    "sosfreqz": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        jax_jit=False,
        allow_dask_compute=True,
    ),
    "spline_filter": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "tf2sos": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "tf2zpk": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "unique_roots": xp_capabilities(np_only=True, exceptions=["cupy"]),
    "upfirdn": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy"],
        jax_jit=False,
        allow_dask_compute=True,
    ...
    "vectorstrength": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "torch"],
        allow_dask_compute=True,
        jax_jit=False,
    ),
    "wiener": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy", "jax.numpy"],
        allow_dask_compute=True,
        jax_jit=False,
    ...
    "zpk2sos": xp_capabilities(
        cpu_only=True, exceptions=["cupy"], jax_jit=False, allow_dask_compute=True
    ),
    "zpk2tf": xp_capabilities(
        cpu_only=True,
        exceptions=["cupy"],
        jax_jit=False,
        allow_dask_compute=True,
