...
@pytest.mark.skipif(IS_EDITABLE, reason="Editable install cannot find .pxd headers.")
@pytest.mark.skipif(
    (platform.system() == "Windows" and sysconfig.get_config_var("Py_GIL_DISABLED")),
    reason="gh-22039",
)
@pytest.mark.skipif(
    platform.machine() in ["wasm32", "wasm64"], reason="Can't start subprocess"
)
