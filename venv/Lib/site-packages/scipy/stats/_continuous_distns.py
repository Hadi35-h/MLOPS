    ...
    def _entropy(self, a, b):
        ...
        def threshold_large(v):
            ...
            return xpx.apply_where(
                v != 1.0, (d, j), lambda d_, j_: d_ * 10 ** (7 + j_), fill_value=1000
            )
        ...
        return _lazyselect(
            ...
            [asymptotic_ab_large, asymptotic_b_large, asymptotic_a_large, regular],
            [a, b],
        )
...
class ncx2_gen(rv_continuous):
    ...
    def _cdf(self, x, df, nc):
        with np.errstate(over="ignore"):  # see gh-17432
            return xpx.apply_where(
                nc != 0, (x, df, nc), sc.chndtr, lambda x, df, _: chi2._cdf(x, df)
            )

    def _ppf(self, q, df, nc):
        with np.errstate(over="ignore"):  # see gh-17432
            return xpx.apply_where(
                nc != 0, (q, df, nc), sc.chndtrix, lambda x, df, _: chi2._ppf(x, df)
            )
