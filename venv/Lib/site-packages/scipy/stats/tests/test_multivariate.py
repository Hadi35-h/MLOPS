...
class TestMarginal:
    @pytest.mark.parametrize(
        "dist,kwargs", [(multivariate_normal, {}), (multivariate_t, {"df": 4})]
    )
    ...
    def test_marginal_distribution(
        self, dist, X_ndim, dimensions, frozen, cov_object, kwargs
    ):
...
class TestMatrixT:
    ...
    def test_against_multivariate_t(self, shape_case):
        ...
        t_mat = matrix_t(mean=M, row_spread=row_spread, col_spread=col_spread, df=df)
