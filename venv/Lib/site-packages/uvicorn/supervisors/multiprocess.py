...
class Process:
    ...
    def wait_until_ready(
        self, timeout: float, should_exit: threading.Event | None = None
    ) -> bool:
...
class Multiprocess:
    ...
    def run(self) -> None:
        ...
        color_message = "Started parent process [{}]".format(
            style(str(os.getpid()), fg="cyan", bold=True)
        )
    ...
    def keep_subprocess_alive(self) -> None:
        ...
        for idx, process in enumerate(self.processes):
            ...
            if process.exitcode == STARTUP_FAILURE:
                ...
                logger.error(
                    f"Child process [{process.pid}] failed to start, stopping the parent process."
                )
