    ...
    async def __call__(
        ...
        if client_host in self.trusted_hosts:
            ...
            if x_forwarded_for_values:
                ...
                host, port = self.trusted_hosts.get_trusted_client_address(
                    x_forwarded_for
                )
...
class _TrustedHosts:
    ...
    def __init__(self, trusted_hosts: list[str] | str) -> None:
        ...
        self.trusted_networks: set[ipaddress.IPv4Network | ipaddress.IPv6Network] = (
            set()
        )
    ...
    def _compute_trust(self, host: str) -> bool:
        try:
            ...
            return ip in self.trusted_hosts or any(
                ip in net for net in self.trusted_networks
            )
        except ValueError:
