...
def _cloned_intersection(a: Iterable[_CLE], b: Iterable[_CLE]) -> Set[_CLE]:
    ...
    """
    all_overlap: Set[_CLE] = set(_expand_cloned(a)).intersection(_expand_cloned(b))
...
class DialectKWArgs:
    ...
    def get_dialect_option(
        ...
        *,
        ...
        if argument_name in registry.get(self.__class__, {}):
            if deprecated_fallback is None or dialect.name == deprecated_fallback:
            ...
            if (
                ...
                and argument_name in self.dialect_options[dialect.name]._non_defaults
            ):
    ...
    def argument_for(cls, dialect_name: str, argument_name: str, default: Any) -> None:
        ...
        construct_arg_dictionary: Optional[Dict[Any, Any]] = DialectKWArgs._kw_registry[
            dialect_name
        ]
    ...
    _kw_registry: util.PopulateDict[str, Optional[Dict[Any, Any]]] = util.PopulateDict(
        _kw_reg_for_dialect
    )
