            ...
            if col_expr is not column:
                ...
                render_with_label = (
                    (
                        ...
                        column.operator in (operators.is_false, operators.is_true)
    ...
    def _deliver_insertmanyvalues_batches(
        ...
        if imv.is_default_expr and not self.dialect.supports_default_metavalue:
            ...
            and (
                ...
                or (imv.includes_upsert_behaviors and not imv.embed_values_counter)
            )
        ):
    ...
    def visit_insert(
        ...
        if insert_stmt.select is not None:
            ...
            if (
                ...
                if render_bind_casts:
                    ...
                    colnames_w_cast = ", ".join(
                        ...
                        for i, (col, _, expr, _) in enumerate(crud_params_single)
                    )
                else:
                    colnames_w_cast = ", ".join(
            ...
            self._insertmanyvalues = _InsertManyValues(
                ...
                sort_by_parameter_order=(insert_stmt._sort_by_parameter_order),
                includes_upsert_behaviors=(insert_stmt._post_values_clause is not None),
                sentinel_columns=add_sentinel_cols,
                num_sentinel_columns=(
                    len(add_sentinel_cols) if add_sentinel_cols else 0
                ),
...
class DDLCompiler(Compiled):
    ...
    def define_constraint_preamble(self, constraint: Constraint, **kw: Any) -> str:
        text = ""
        if constraint.name is not None:
            formatted_name = self.preparer.format_constraint(constraint)
    ...
    def define_unique_body(self, constraint: UniqueConstraint, **kw: Any) -> str:
        text = "UNIQUE %s(%s)" % (
