...
class MSDDLCompiler(compiler.DDLCompiler):
    ...
    def visit_drop_index(self, drop: DropIndex, **kw: Any) -> str:
        index_name = self._prepared_index_name(drop.element, include_schema=False)
...
order by
    ...
    def get_columns(self, connection, tablename, dbname, owner, schema, **kw):
        ...
        s = (
            ...
            .join(
                sys_types,
                onclause=sys_columns.c.user_type_id == sys_types.c.user_type_id,
            )
            .outerjoin(
                sys_base_types,
                onclause=sql.and_(
                    sys_types.c.system_type_id == sys_base_types.c.system_type_id,
                    sys_base_types.c.user_type_id == sys_base_types.c.system_type_id,
                ),
            )
            .outerjoin(
