...
_ToIndex1: TypeAlias = (
    slice | EllipsisType | NDArray[np.integer | np.bool] | _NestedSequence[int] | None
)
_ToIndex2: TypeAlias = (
    tuple[_ToIndex1, _ToIndex1 | SupportsIndex]
    | tuple[_ToIndex1 | SupportsIndex, _ToIndex1]
)
...
class matrix(np.ndarray[_ShapeT_co, _DTypeT_co]):
    ...
    @overload
    def __getitem__(
        self: _Matrix[np.void], key: list[str], /
    ) -> matrix[
        _2D, _DTypeT_co
