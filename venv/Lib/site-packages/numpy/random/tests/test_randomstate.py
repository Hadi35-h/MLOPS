...
if np.iinfo(np.long).max < 2**32:
    ...
    INT_FUNC_HASHES = {
        "binomial": "2fbead005fc63942decb5326d36a1f32fe2c9d32c904ee61e46866b88447c263",  # noqa: E501
    ...
    INT_FUNC_HASHES = {
        "binomial": "8626dd9d052cb608e93d8868de0a7b347258b199493871a1dc56e2a26cacb112",  # noqa: E501
...
class TestSetState:
    ...
    def test_invalid_legacy_state_setting(self):
        ...
        assert_raises(
            TypeError, random_state.set_state, np.array(new_state, dtype=object)
        )
...
class TestRandint:
    ...
    def test_repeatability(self):
        ...
        tgt = {
            "bool": "509aea74d792fb931784c4b0135392c65aec64beee12b0cc167548a2c3d31e71",  # noqa: E501
    ...
    def test_repeatability_32bit_boundary_broadcasting(self):
        ...
        for size in [None, (5, 3, 3)]:
            ...
            x = rng.randint([[-1], [0], [1]], [2**32 - 1, 2**32, 2**32 + 1], size=size)
...
class TestRandomDist:
    ...
    def test_beta(self):
        rng = random.RandomState(self.seed)
        actual = rng.beta(0.1, 0.9, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_binomial(self):
        rng = random.RandomState(self.seed)
        actual = rng.binomial(100.123, 0.456, size=(3, 2))
        desired = np.array([[37, 43], [42, 48], [46, 45]])
        assert_array_equal(actual, desired)

        rng = random.RandomState(self.seed)
        actual = rng.binomial(100.123, 0.456)
        desired = 37
        assert_array_equal(actual, desired)
    ...
    def test_dirichlet_alpha_non_contiguous(self):
        ...
        rng = random.RandomState(self.seed)
        contig = rng.dirichlet(np.ascontiguousarray(alpha), size=(3, 2))
    ...
    def test_geometric(self):
        rng = random.RandomState(self.seed)
        actual = rng.geometric(0.123456789, size=(3, 2))
    ...
    def test_gumbel(self):
        rng = random.RandomState(self.seed)
        actual = rng.gumbel(loc=0.123456789, scale=2.0, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_laplace(self):
        rng = random.RandomState(self.seed)
        actual = rng.laplace(loc=0.123456789, scale=2.0, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_logistic(self):
        rng = random.RandomState(self.seed)
        actual = rng.logistic(loc=0.123456789, scale=2.0, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_lognormal(self):
        rng = random.RandomState(self.seed)
        actual = rng.lognormal(mean=0.123456789, sigma=2.0, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_logseries(self):
        rng = random.RandomState(self.seed)
        actual = rng.logseries(p=0.923456789, size=(3, 2))
    ...
    def test_multinomial(self):
        rng = random.RandomState(self.seed)
        actual = rng.multinomial(20, [1 / 6.0] * 6, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_multivariate_normal(self):
        ...
        assert_no_warnings(rng.multivariate_normal, mean, cov, check_valid="ignore")
        ...
        cov = np.eye(2)
        assert_raises(
            ValueError, rng.multivariate_normal, mean, cov, check_valid="other"
        )
        assert_raises(ValueError, rng.multivariate_normal, np.zeros((2, 1, 1)), cov)
        assert_raises(ValueError, rng.multivariate_normal, mu, np.empty((3, 2)))
        assert_raises(ValueError, rng.multivariate_normal, mu, np.eye(3))

    def test_negative_binomial(self):
        rng = random.RandomState(self.seed)
        actual = rng.negative_binomial(n=100, p=0.12345, size=(3, 2))
    ...
    def test_noncentral_chisquare(self):
        ...
        actual = rng.noncentral_chisquare(df=0.5, nonc=0.2, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_noncentral_f(self):
        rng = random.RandomState(self.seed)
        actual = rng.noncentral_f(dfnum=5, dfden=2, nonc=1, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_normal(self):
        rng = random.RandomState(self.seed)
        actual = rng.normal(loc=0.123456789, scale=2.0, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_pareto(self):
        rng = random.RandomState(self.seed)
        actual = rng.pareto(a=0.123456789, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_poisson(self):
        rng = random.RandomState(self.seed)
        actual = rng.poisson(lam=0.123456789, size=(3, 2))
    ...
    def test_power(self):
        rng = random.RandomState(self.seed)
        actual = rng.power(a=0.123456789, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_triangular(self):
        rng = random.RandomState(self.seed)
        actual = rng.triangular(left=5.12, mode=10.23, right=20.34, size=(3, 2))
        desired = np.array(
            [
    ...
    def test_vonmises_large(self):
        ...
        rng = random.RandomState(self.seed)
        actual = rng.vonmises(mu=0.0, kappa=1e7, size=3)
        desired = np.array(
...
class TestBroadcast:
    ...
    def test_triangular(self):
        ...
        assert_raises(ValueError, rng.triangular, bad_left_two * 3, bad_mode_two, right)
        ...
        assert_raises(ValueError, rng.triangular, bad_left_two, bad_mode_two * 3, right)
        ...
        assert_raises(ValueError, rng.triangular, bad_left_two, bad_mode_two, right * 3)

        assert_raises(ValueError, rng.triangular, 10.0, 0.0, 20.0)
        assert_raises(ValueError, rng.triangular, 10.0, 25.0, 20.0)
        assert_raises(ValueError, rng.triangular, 10.0, 10.0, 10.0)
