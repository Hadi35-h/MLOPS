...
class TestDateTime:
    ...
    def test_datetime_scalar_construction(self):
        ...
        assert_equal(repr(np.datetime64("NaT")), "np.datetime64('NaT','generic')")
        assert_equal(str(np.datetime64("2011-02")), "2011-02")
        assert_equal(repr(np.datetime64("2011-02")), "np.datetime64('2011-02')")
        assert_equal(
            repr(np.datetime64("NaT").astype(np.dtype("datetime64[ns]"))),
    ...
    def test_datetime_as_string_timezone(self):
        ...
        assert_equal(
            np.datetime_as_string(a, timezone=ZoneInfo("US/Central")),
            "2010-03-15T01:30-0500",
        )
        assert_equal(
            np.datetime_as_string(a, timezone=ZoneInfo("US/Eastern")),
            "2010-03-15T02:30-0400",
        )
        assert_equal(
            np.datetime_as_string(a, timezone=ZoneInfo("US/Pacific")),
            "2010-03-14T23:30-0700",
        )

        assert_equal(
            np.datetime_as_string(b, timezone=ZoneInfo("US/Central")),
            "2010-02-15T00:30-0600",
        )
        assert_equal(
            np.datetime_as_string(b, timezone=ZoneInfo("US/Eastern")),
            "2010-02-15T01:30-0500",
        )
        assert_equal(
            np.datetime_as_string(b, timezone=ZoneInfo("US/Pacific")),
        ...
        assert_equal(
            np.datetime_as_string(
                a, unit="D", timezone=ZoneInfo("US/Pacific"), casting="unsafe"
            ),
            "2010-03-14",
        )
        assert_equal(
            np.datetime_as_string(
                b, unit="D", timezone=ZoneInfo("US/Central"), casting="unsafe"
            ),
            "2010-02-15",
        )
