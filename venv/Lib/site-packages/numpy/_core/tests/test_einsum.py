...
class TestEinsum:
    ...
    def test_einsum_sorting_behavior(self):
        ...
        expected_indices = [
            chr(i + ord("A")) if i < 26 else chr(i - 26 + ord("a")) for i in range(n2)
        ]
        assert_equal(
            output_indices2,
    ...
    def test_einsum_object_errors(self):
        ...
        b = np.array([DestructoBox(i, 100) for i in range(27)], dtype="object").reshape(
            3, 3, 3
        )
...
def test_einsum_chunking_precision():
    ...
    """
    num = 1_000_000
    value = 1.0 + np.finfo(np.float64).eps * 8196
