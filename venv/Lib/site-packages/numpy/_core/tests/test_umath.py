    ...
    def test_floor_division_corner_cases(self, dtype):
        ...
        with warnings.catch_warnings():
            warnings.filterwarnings(
                "ignore", "invalid value encountered in floor_divide", RuntimeWarning
            )
...
class TestRemainder:
    ...
    def test_float_remainder_corner_cases(self):
        ...
        with warnings.catch_warnings():
            ...
            warnings.filterwarnings(
                "ignore", "invalid value encountered in fmod", RuntimeWarning
            )
            for dt in np.typecodes["Float"]:
                fone = np.array(1.0, dtype=dt)
                fzer = np.array(0.0, dtype=dt)
...
class TestSpecialFloats:
    ...
    def test_unary_spurious_fpexception(self, ufunc, dtype, data, escape):
        ...
        if (
            ...
            and any(np.isnan(d) if isinstance(d, (int, float)) else False for d in data)
        ):
