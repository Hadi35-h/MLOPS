...
def _stableify(
    ...
    if isinstance(obj, NwDataFrame):
        return DataFrame(
            obj._compliant_frame._with_version(Version.V2), level=obj._level
        )
...
def from_native(
    native_object: (
        IntoLazyFrameT | IntoDataFrameT | IntoSeriesT | IntoFrame | IntoSeries | T
    ),
    *,
