...
class ExprStringNamespace(Generic[ExprT]):
    ...
    def strip_chars_start(self, characters: str | None = None) -> ExprT:
        ...
        return self._expr._append_node(
            ExprNode(
                ExprKind.ELEMENTWISE, "str.strip_chars_start", characters=characters
            )
        )
    ...
    def split(self, by: str) -> ExprT:
        ...
        """
        return self._expr._append_node(
            ExprNode(ExprKind.ELEMENTWISE, "str.split", by=by)
        )
    ...
    def to_uppercase(self) -> ExprT:
        ...
        """
        return self._expr._append_node(
            ExprNode(ExprKind.ELEMENTWISE, "str.to_uppercase")
        )
    ...
    def to_lowercase(self) -> ExprT:
        ...
        """
        return self._expr._append_node(
            ExprNode(ExprKind.ELEMENTWISE, "str.to_lowercase")
        )
    ...
    def to_titlecase(self) -> ExprT:
        ...
        """
        return self._expr._append_node(
            ExprNode(ExprKind.ELEMENTWISE, "str.to_titlecase")
        )
