...
class Expr:
    ...
    def fill_nan(self, value: float | None) -> Self:
        ...
        """
        return self._append_node(
            ExprNode(ExprKind.ELEMENTWISE, "fill_nan", value=value)
        )
    ...
    def over(
        ...
        *partition_by: str | Sequence[str],
        ...
        node = ExprNode(
            ExprKind.OVER,
            "over",
            partition_by=flat_partition_by,
            order_by=flat_order_by,
        )
    ...
    def is_first_distinct(self) -> Self:
        ...
        """
        return self._append_node(
            ExprNode(ExprKind.ORDERABLE_WINDOW, "is_first_distinct")
        )
    ...
    def is_last_distinct(self) -> Self:
        ...
        """
        return self._append_node(
            ExprNode(ExprKind.ORDERABLE_WINDOW, "is_last_distinct")
        )
