    ...
    *,
    ...
    if str_dtype == "category":
        return native_categorical_to_narwhals_dtype(
            native_dtype, version, implementation
        )
    if str_dtype != "object":
...
NW_TO_PD_DTYPES_BACKEND: Mapping[
    type[DType], Mapping[DTypeBackend, str | type[Any]]
] = {
    dtypes.Float64: {
    ...
    dtypes.Int64: {
        "pyarrow": "Int64[pyarrow]",
        "numpy_nullable": "Int64",
        None: "int64",
    },
    dtypes.Int32: {
        "pyarrow": "Int32[pyarrow]",
        "numpy_nullable": "Int32",
        None: "int32",
    },
    dtypes.Int16: {
        "pyarrow": "Int16[pyarrow]",
        "numpy_nullable": "Int16",
        None: "int16",
    },
    ...
    dtypes.UInt8: {
        "pyarrow": "UInt8[pyarrow]",
        "numpy_nullable": "UInt8",
        None: "uint8",
    },
    dtypes.Boolean: {
...
def narwhals_to_native_arrow_dtype(
    ...
    if is_pandas_or_modin(implementation) and PANDAS_VERSION >= (2, 2):
        try:
            ...
            msg = f"Unable to convert to {dtype} due to the following exception: {exc.msg}"
...
def binary_string_sum_fallback(  # pragma: no cover
    ...
    if isinstance(right, pdx.Series):
        ...
        if hasattr(left.values, "__arrow_array__") and hasattr(
            ...
            left_arrow = (
                left.values.__arrow_array__().type
            )  # noqa: PD011  # type: ignore[attr-defined]
            right_arrow = (
                right.values.__arrow_array__().type
            )  # noqa: PD011  # type: ignore[attr-defined]
            if pa.types.is_string(left_arrow) and pa.types.is_large_string(right_arrow):
                ...
                return left.astype(pd_pa_large_string) + right.astype(
                    pd_pa_large_string
                )
        else:
            pass
